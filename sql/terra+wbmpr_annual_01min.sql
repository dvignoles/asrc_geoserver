...
DROP VIEW IF EXISTS "v_discharge_confluence_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_discharge_confluence_annual_terra+wbmpr_01min"
    AS
    SELECT * FROM crosstab(
    $$SELECT sampleid, year, discharge
        FROM "discharge_confluence_annual_terra+wbmpr_01min"
        ORDER BY sampleid$$,
...
DROP VIEW IF EXISTS "v_riverwidth_confluence_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_riverwidth_confluence_annual_terra+wbmpr_01min"
    AS
    SELECT * FROM crosstab(
    $$SELECT sampleid, year, riverwidth
        FROM "riverwidth_confluence_annual_terra+wbmpr_01min"
        ORDER BY sampleid$$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
SELECT 2017 UNION ALL
...
DROP VIEW IF EXISTS "v_riverdepth_confluence_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_riverdepth_confluence_annual_terra+wbmpr_01min"
    AS
    SELECT * FROM crosstab(
    $$SELECT sampleid, year, riverdepth
        FROM "riverdepth_confluence_annual_terra+wbmpr_01min"
        ORDER BY sampleid$$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
SELECT 2017 UNION ALL
...
DROP VIEW IF EXISTS "v_discharge_mouth_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_discharge_mouth_annual_terra+wbmpr_01min"
    AS
    SELECT * FROM crosstab(
    $$SELECT sampleid, year, discharge
        FROM "discharge_mouth_annual_terra+wbmpr_01min"
        ORDER BY sampleid$$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
SELECT 2017 UNION ALL
...
DROP VIEW IF EXISTS "v_riverwidth_mouth_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_riverwidth_mouth_annual_terra+wbmpr_01min"
    AS
    SELECT * FROM crosstab(
    $$SELECT sampleid, year, riverwidth
        FROM "riverwidth_mouth_annual_terra+wbmpr_01min"
        ORDER BY sampleid$$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
SELECT 2017 UNION ALL
...
DROP VIEW IF EXISTS "v_riverdepth_mouth_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_riverdepth_mouth_annual_terra+wbmpr_01min"
    AS
    SELECT * FROM crosstab(
    $$SELECT sampleid, year, riverdepth
        FROM "riverdepth_mouth_annual_terra+wbmpr_01min"
        ORDER BY sampleid$$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
SELECT 2017 UNION ALL
...
DROP VIEW IF EXISTS "v_discharge_reservoirdam_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_discharge_reservoirdam_annual_terra+wbmpr_01min"
    AS
    SELECT * FROM crosstab(
    $$SELECT sampleid, year, discharge
        FROM "discharge_reservoirdam_annual_terra+wbmpr_01min"
        ORDER BY sampleid$$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
SELECT 2017 UNION ALL
...
DROP VIEW IF EXISTS "v_riverwidth_reservoirdam_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_riverwidth_reservoirdam_annual_terra+wbmpr_01min"
    AS
    SELECT * FROM crosstab(
    $$SELECT sampleid, year, riverwidth
        FROM "riverwidth_reservoirdam_annual_terra+wbmpr_01min"
        ORDER BY sampleid$$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
SELECT 2017 UNION ALL
...
DROP VIEW IF EXISTS "v_riverdepth_reservoirdam_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_riverdepth_reservoirdam_annual_terra+wbmpr_01min"
    AS
    SELECT * FROM crosstab(
    $$SELECT sampleid, year, riverdepth
        FROM "riverdepth_reservoirdam_annual_terra+wbmpr_01min"
        ORDER BY sampleid$$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
SELECT 2017 UNION ALL
...
DROP VIEW IF EXISTS "v_evapotranspiration_basin_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_evapotranspiration_basin_annual_terra+wbmpr_01min"
    AS
...
,(evapotranspiration_2019).zmean as evapotranspiration_zonalmean_2019,
    ...
    $$SELECT sampleid, year, (zonalmean, zonalmin, zonalmax)::zonaloutput
        FROM "evapotranspiration_basin_annual_terra+wbmpr_01min"
        ORDER BY 1
        $$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
...
DROP VIEW IF EXISTS "v_soilmoisture_basin_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_soilmoisture_basin_annual_terra+wbmpr_01min"
    AS
...
DROP VIEW IF EXISTS "v_relativesoilmoisture_basin_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_relativesoilmoisture_basin_annual_terra+wbmpr_01min"
    AS
...
,(relativesoilmoisture_2019).zmean as relativesoilmoisture_zonalmean_2019,
    ...
    FROM crosstab(
    $$SELECT sampleid, year, (zonalmean, zonalmin, zonalmax)::zonaloutput
        FROM "relativesoilmoisture_basin_annual_terra+wbmpr_01min"
        ORDER BY 1
        $$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
...
DROP VIEW IF EXISTS "v_rainpet_basin_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_rainpet_basin_annual_terra+wbmpr_01min"
    AS
...
,(rainpet_2019).zmean as rainpet_zonalmean_2019,
    ...
    FROM crosstab(
    $$SELECT sampleid, year, (zonalmean, zonalmin, zonalmax)::zonaloutput
        FROM "rainpet_basin_annual_terra+wbmpr_01min"
        ORDER BY 1
        $$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
...
DROP VIEW IF EXISTS "v_snowpack_basin_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_snowpack_basin_annual_terra+wbmpr_01min"
    AS
...
,(snowpack_2019).zmean as snowpack_zonalmean_2019,
    ...
    FROM crosstab(
    $$SELECT sampleid, year, (zonalmean, zonalmin, zonalmax)::zonaloutput
        FROM "snowpack_basin_annual_terra+wbmpr_01min"
        ORDER BY 1
        $$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
...
DROP VIEW IF EXISTS "v_runoff_basin_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_runoff_basin_annual_terra+wbmpr_01min"
    AS
...
,(runoff_2019).zmean as runoff_zonalmean_2019,
    ...
    FROM crosstab(
    $$SELECT sampleid, year, (zonalmean, zonalmin, zonalmax)::zonaloutput
        FROM "runoff_basin_annual_terra+wbmpr_01min"
        ORDER BY 1
        $$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
...
DROP VIEW IF EXISTS "v_evapotranspiration_subbasin_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_evapotranspiration_subbasin_annual_terra+wbmpr_01min"
    AS
    SELECT sampleid, (evapotranspiration_1958).zmean as evapotranspiration_zonalmean_1958,
       (evapotranspiration_1958).zmin as evapotranspiration_zonalmin_1958,
       (evapotranspiration_1958).zmax as evapotranspiration_zonalmax_1958
...
,(evapotranspiration_2019).zmean as evapotranspiration_zonalmean_2019,
    ...
    FROM crosstab(
    $$SELECT sampleid, year, (zonalmean, zonalmin, zonalmax)::zonaloutput
        FROM "evapotranspiration_subbasin_annual_terra+wbmpr_01min"
        ORDER BY 1
        $$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
...
DROP VIEW IF EXISTS "v_soilmoisture_subbasin_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_soilmoisture_subbasin_annual_terra+wbmpr_01min"
    AS
    SELECT sampleid, (soilmoisture_1958).zmean as soilmoisture_zonalmean_1958,
       (soilmoisture_1958).zmin as soilmoisture_zonalmin_1958,
       (soilmoisture_1958).zmax as soilmoisture_zonalmax_1958
...
,(soilmoisture_2019).zmean as soilmoisture_zonalmean_2019,
    ...
    FROM crosstab(
    $$SELECT sampleid, year, (zonalmean, zonalmin, zonalmax)::zonaloutput
        FROM "soilmoisture_subbasin_annual_terra+wbmpr_01min"
        ORDER BY 1
        $$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
...
DROP VIEW IF EXISTS "v_relativesoilmoisture_subbasin_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_relativesoilmoisture_subbasin_annual_terra+wbmpr_01min"
    AS
    SELECT sampleid, (relativesoilmoisture_1958).zmean as relativesoilmoisture_zonalmean_1958,
       (relativesoilmoisture_1958).zmin as relativesoilmoisture_zonalmin_1958,
       (relativesoilmoisture_1958).zmax as relativesoilmoisture_zonalmax_1958
...
,(relativesoilmoisture_2019).zmean as relativesoilmoisture_zonalmean_2019,
    ...
    FROM crosstab(
    $$SELECT sampleid, year, (zonalmean, zonalmin, zonalmax)::zonaloutput
        FROM "relativesoilmoisture_subbasin_annual_terra+wbmpr_01min"
        ORDER BY 1
        $$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
...
DROP VIEW IF EXISTS "v_rainpet_subbasin_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_rainpet_subbasin_annual_terra+wbmpr_01min"
    AS
    SELECT sampleid, (rainpet_1958).zmean as rainpet_zonalmean_1958,
       (rainpet_1958).zmin as rainpet_zonalmin_1958,
       (rainpet_1958).zmax as rainpet_zonalmax_1958
...
,(rainpet_2019).zmean as rainpet_zonalmean_2019,
    ...
    FROM crosstab(
    $$SELECT sampleid, year, (zonalmean, zonalmin, zonalmax)::zonaloutput
        FROM "rainpet_subbasin_annual_terra+wbmpr_01min"
        ORDER BY 1
        $$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
...
DROP VIEW IF EXISTS "v_snowpack_subbasin_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_snowpack_subbasin_annual_terra+wbmpr_01min"
    AS
    SELECT sampleid, (snowpack_1958).zmean as snowpack_zonalmean_1958,
       (snowpack_1958).zmin as snowpack_zonalmin_1958,
       (snowpack_1958).zmax as snowpack_zonalmax_1958
...
,(snowpack_2019).zmean as snowpack_zonalmean_2019,
    ...
    FROM crosstab(
    $$SELECT sampleid, year, (zonalmean, zonalmin, zonalmax)::zonaloutput
        FROM "snowpack_subbasin_annual_terra+wbmpr_01min"
        ORDER BY 1
        $$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
...
DROP VIEW IF EXISTS "v_runoff_subbasin_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_runoff_subbasin_annual_terra+wbmpr_01min"
    AS
    SELECT sampleid, (runoff_1958).zmean as runoff_zonalmean_1958,
       (runoff_1958).zmin as runoff_zonalmin_1958,
       (runoff_1958).zmax as runoff_zonalmax_1958
...
,(runoff_2019).zmean as runoff_zonalmean_2019,
    ...
    FROM crosstab(
    $$SELECT sampleid, year, (zonalmean, zonalmin, zonalmax)::zonaloutput
        FROM "runoff_subbasin_annual_terra+wbmpr_01min"
        ORDER BY 1
        $$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
...
DROP VIEW IF EXISTS "v_evapotranspiration_country_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_evapotranspiration_country_annual_terra+wbmpr_01min"
    AS
    SELECT sampleid, (evapotranspiration_1958).zmean as evapotranspiration_zonalmean_1958,
       (evapotranspiration_1958).zmin as evapotranspiration_zonalmin_1958,
       (evapotranspiration_1958).zmax as evapotranspiration_zonalmax_1958
...
,(evapotranspiration_2019).zmean as evapotranspiration_zonalmean_2019,
    ...
    FROM crosstab(
    $$SELECT sampleid, year, (zonalmean, zonalmin, zonalmax)::zonaloutput
        FROM "evapotranspiration_country_annual_terra+wbmpr_01min"
        ORDER BY 1
        $$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
...
DROP VIEW IF EXISTS "v_soilmoisture_country_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_soilmoisture_country_annual_terra+wbmpr_01min"
    AS
    SELECT sampleid, (soilmoisture_1958).zmean as soilmoisture_zonalmean_1958,
       (soilmoisture_1958).zmin as soilmoisture_zonalmin_1958,
       (soilmoisture_1958).zmax as soilmoisture_zonalmax_1958
...
,(soilmoisture_2019).zmean as soilmoisture_zonalmean_2019,
    ...
    FROM crosstab(
    $$SELECT sampleid, year, (zonalmean, zonalmin, zonalmax)::zonaloutput
        FROM "soilmoisture_country_annual_terra+wbmpr_01min"
        ORDER BY 1
        $$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
...
DROP VIEW IF EXISTS "v_relativesoilmoisture_country_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_relativesoilmoisture_country_annual_terra+wbmpr_01min"
    AS
    SELECT sampleid, (relativesoilmoisture_1958).zmean as relativesoilmoisture_zonalmean_1958,
       (relativesoilmoisture_1958).zmin as relativesoilmoisture_zonalmin_1958,
       (relativesoilmoisture_1958).zmax as relativesoilmoisture_zonalmax_1958
...
,(relativesoilmoisture_2019).zmean as relativesoilmoisture_zonalmean_2019,
    ...
    FROM crosstab(
    $$SELECT sampleid, year, (zonalmean, zonalmin, zonalmax)::zonaloutput
        FROM "relativesoilmoisture_country_annual_terra+wbmpr_01min"
        ORDER BY 1
        $$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
...
DROP VIEW IF EXISTS "v_rainpet_country_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_rainpet_country_annual_terra+wbmpr_01min"
    AS
    SELECT sampleid, (rainpet_1958).zmean as rainpet_zonalmean_1958,
       (rainpet_1958).zmin as rainpet_zonalmin_1958,
       (rainpet_1958).zmax as rainpet_zonalmax_1958
...
,(rainpet_2019).zmean as rainpet_zonalmean_2019,
    ...
    FROM crosstab(
    $$SELECT sampleid, year, (zonalmean, zonalmin, zonalmax)::zonaloutput
        FROM "rainpet_country_annual_terra+wbmpr_01min"
        ORDER BY 1
        $$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
...
DROP VIEW IF EXISTS "v_snowpack_country_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_snowpack_country_annual_terra+wbmpr_01min"
    AS
    SELECT sampleid, (snowpack_1958).zmean as snowpack_zonalmean_1958,
       (snowpack_1958).zmin as snowpack_zonalmin_1958,
       (snowpack_1958).zmax as snowpack_zonalmax_1958
...
,(snowpack_2019).zmean as snowpack_zonalmean_2019,
    ...
    FROM crosstab(
    $$SELECT sampleid, year, (zonalmean, zonalmin, zonalmax)::zonaloutput
        FROM "snowpack_country_annual_terra+wbmpr_01min"
        ORDER BY 1
        $$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
...
DROP VIEW IF EXISTS "v_runoff_country_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_runoff_country_annual_terra+wbmpr_01min"
    AS
    SELECT sampleid, (runoff_1958).zmean as runoff_zonalmean_1958,
       (runoff_1958).zmin as runoff_zonalmin_1958,
       (runoff_1958).zmax as runoff_zonalmax_1958
...
,(runoff_2019).zmean as runoff_zonalmean_2019,
    ...
    FROM crosstab(
    $$SELECT sampleid, year, (zonalmean, zonalmin, zonalmax)::zonaloutput
        FROM "runoff_country_annual_terra+wbmpr_01min"
        ORDER BY 1
        $$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
...
DROP VIEW IF EXISTS "v_evapotranspiration_state_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_evapotranspiration_state_annual_terra+wbmpr_01min"
    AS
    SELECT sampleid, (evapotranspiration_1958).zmean as evapotranspiration_zonalmean_1958,
       (evapotranspiration_1958).zmin as evapotranspiration_zonalmin_1958,
       (evapotranspiration_1958).zmax as evapotranspiration_zonalmax_1958
...
,(evapotranspiration_2019).zmean as evapotranspiration_zonalmean_2019,
    ...
    FROM crosstab(
    $$SELECT sampleid, year, (zonalmean, zonalmin, zonalmax)::zonaloutput
        FROM "evapotranspiration_state_annual_terra+wbmpr_01min"
        ORDER BY 1
        $$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
...
DROP VIEW IF EXISTS "v_soilmoisture_state_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_soilmoisture_state_annual_terra+wbmpr_01min"
    AS
    SELECT sampleid, (soilmoisture_1958).zmean as soilmoisture_zonalmean_1958,
       (soilmoisture_1958).zmin as soilmoisture_zonalmin_1958,
       (soilmoisture_1958).zmax as soilmoisture_zonalmax_1958
...
,(soilmoisture_2019).zmean as soilmoisture_zonalmean_2019,
    ...
    FROM crosstab(
    $$SELECT sampleid, year, (zonalmean, zonalmin, zonalmax)::zonaloutput
        FROM "soilmoisture_state_annual_terra+wbmpr_01min"
        ORDER BY 1
        $$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
...
DROP VIEW IF EXISTS "v_relativesoilmoisture_state_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_relativesoilmoisture_state_annual_terra+wbmpr_01min"
    AS
    SELECT sampleid, (relativesoilmoisture_1958).zmean as relativesoilmoisture_zonalmean_1958,
       (relativesoilmoisture_1958).zmin as relativesoilmoisture_zonalmin_1958,
       (relativesoilmoisture_1958).zmax as relativesoilmoisture_zonalmax_1958
...
,(relativesoilmoisture_2019).zmean as relativesoilmoisture_zonalmean_2019,
    ...
    FROM crosstab(
    $$SELECT sampleid, year, (zonalmean, zonalmin, zonalmax)::zonaloutput
        FROM "relativesoilmoisture_state_annual_terra+wbmpr_01min"
        ORDER BY 1
        $$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
...
DROP VIEW IF EXISTS "v_rainpet_state_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_rainpet_state_annual_terra+wbmpr_01min"
    AS
    SELECT sampleid, (rainpet_1958).zmean as rainpet_zonalmean_1958,
       (rainpet_1958).zmin as rainpet_zonalmin_1958,
       (rainpet_1958).zmax as rainpet_zonalmax_1958
...
,(rainpet_2019).zmean as rainpet_zonalmean_2019,
    ...
    FROM crosstab(
    $$SELECT sampleid, year, (zonalmean, zonalmin, zonalmax)::zonaloutput
        FROM "rainpet_state_annual_terra+wbmpr_01min"
        ORDER BY 1
        $$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
...
DROP VIEW IF EXISTS "v_snowpack_state_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_snowpack_state_annual_terra+wbmpr_01min"
    AS
    SELECT sampleid, (snowpack_1958).zmean as snowpack_zonalmean_1958,
       (snowpack_1958).zmin as snowpack_zonalmin_1958,
       (snowpack_1958).zmax as snowpack_zonalmax_1958
...
,(snowpack_2019).zmean as snowpack_zonalmean_2019,
    ...
    FROM crosstab(
    $$SELECT sampleid, year, (zonalmean, zonalmin, zonalmax)::zonaloutput
        FROM "snowpack_state_annual_terra+wbmpr_01min"
        ORDER BY 1
        $$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
...
DROP VIEW IF EXISTS "v_runoff_state_annual_terra+wbmpr_01min";
CREATE OR REPLACE VIEW "v_runoff_state_annual_terra+wbmpr_01min"
    AS
    SELECT sampleid, (runoff_1958).zmean as runoff_zonalmean_1958,
       (runoff_1958).zmin as runoff_zonalmin_1958,
       (runoff_1958).zmax as runoff_zonalmax_1958
...
,(runoff_2019).zmean as runoff_zonalmean_2019,
    ...
    FROM crosstab(
    $$SELECT sampleid, year, (zonalmean, zonalmin, zonalmax)::zonaloutput
        FROM "runoff_state_annual_terra+wbmpr_01min"
        ORDER BY 1
        $$,
    $$SELECT 2019 UNION ALL
SELECT 2018 UNION ALL
